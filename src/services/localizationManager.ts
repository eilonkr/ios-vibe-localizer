 ...
 */
export async function fetchBatchTranslations(requests: TranslationRequest[], sourceLanguageCode: string = "en", model: string, baseSystemPrompt: string = ""): Promise<BatchTranslationResponse> {
